<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['submitBtn2'])) {
            ...
            exit();
        } elseif (isset($_POST['submitBtn1'])) {
            $sqlDelete1 = "DELETE FROM booking_list WHERE id='$ticket_id'";
            $sqlDelete2 = "DELETE FROM payment_list WHERE id='$ticket_id'";
...
<body>
        ...
        <form class="edit" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?id=<?php echo $ticket_id; ?>" method="POST">
            <label>Proceed To Refund? </label>
            <input type="submit" name="submitBtn1" value="Yes">
